...
class AddNewArticleForm extends React.Component {
  saveRef = ref => {
    this.ref = ref;
    return this.ref;
  };
...
const AddNewArticleFormRedux = reduxForm({
  form: 'addNewArticleForm',
  enableReinitialize: true,
})(AddNewArticleForm);

const AddNewArticleFormInit = connect(
  state => ({
    initialValues: state.getIn([reducerKey, 'addNewArticleFormValues']),
    ...state
  })
)(AddNewArticleFormRedux);

export default withStyles(styles)(injectIntl(AddNewArticleFormInit));
