...
import { firebase } from 'enl-firebase';
...
class Register extends React.Component {
  ...
  submitForm(values) {
    setTimeout(() => {
      ...
      this.props.handleRegisterWithEmail(this.state.valueForm.get('username'), this.state.valueForm.get('name'), this.state.valueForm.get('email'), this.state.valueForm.get('password'), this.state.valueForm.get('usertype')); // eslint-disable-line
