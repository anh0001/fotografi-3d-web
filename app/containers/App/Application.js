...
import {
  ...
  SearchProjects, MyProjects, NewProject, EditProject, ReadProject,
  SearchArticles, MyArticles, NewArticle, EditArticle, ReadArticle, Chat,
  Ecommerce, MyProducts, AddProduct, EditProduct, ProductPage, CheckoutPage, Invoice,
...
// import TryContainer from '../TryContainer/Loadable';
// import { UserProfile } from '../Pages/UserProfile/Loadable'
    ...
    return (
      <Dashboard history={history} changeMode={changeMode}>
        <Switch>
          ...
          <Route exact path="/app/:username" component={AnalyticDashboard} />
          ...
          { /* Pages */}
          <Route exact path="/products/:username" component={Parent} />
          <Route path="/app/:username/products/searchproducts" component={Ecommerce} />
          <Route path="/app/:username/products/myproducts" component={MyProducts} />
          <Route path="/app/:username/products/addproduct" component={AddProduct} />
          <Route path="/app/:username/products/editproduct" component={EditProduct} />
          ...
          <Route path="/app/:username/user-profile" component={Profile} />
          <Route path="/app/:username/edit-profile" component={EditProfile} />

          <Route path="/app/projects/searchprojects" component={SearchProjects} />
          <Route path="/app/:username/projects/myprojects" component={MyProjects} />
          <Route path="/app/:username/projects/newproject" component={NewProject} />
          <Route path="/app/:username/projects/edit-project" component={EditProject} />
          <Route path="/app/:username/projects/read-project/:projectid" component={ReadProject} />

          <Route path="/app/posts/searcharticles" component={SearchArticles} />
          <Route path="/app/:username/posts/myarticles" component={MyArticles} />
          <Route path="/app/:username/posts/newarticle" component={NewArticle} />
          <Route path="/app/:username/posts/edit-article" component={EditArticle} />
          <Route path="/app/:username/posts/read-article/:articleid" component={ReadArticle} />
